export type AuditAction =
  ...
  | 'subject.domain.updated'
  | 'subject.domain.deleted'
  | 'subject.assignment.upserted'
  | 'subject.assignment.removed'
  | 'orchestrator.sensor.created'
  | 'orchestrator.sensor.updated'
  | 'orchestrator.binding.upserted'
  | 'orchestrator.binding.removed'
  | 'stage.config.toggled'
