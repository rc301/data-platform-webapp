...
@Component({
  ...
  template: `
    <app-page-header title="Monitoring" subtitle="Platform health, alerts, and cost management" icon="monitoring"></app-page-header>
...
export class MonitoringComponent {
  navLinks = [
    ...
    { path: 'costs', label: 'Cost Explorer', icon: 'attach_money' },
  ];
}
