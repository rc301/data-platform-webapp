...
@Component({
  ...
  template: `
    <app-page-header title="Monitoramento" subtitle="Alertas operacionais da plataforma" icon="monitoring"></app-page-header>
    <nav mat-tab-nav-bar [tabPanel]="tabPanel" *ngIf="navLinks.length > 1">
